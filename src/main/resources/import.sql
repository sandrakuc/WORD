...
INSERT INTO word.WORD_USER (ID, EMAIL, FIRST_NAME, LAST_NAME, LOGIN, PASSWORD, ROLE) VALUES(8, 'a@l.pl', 'Tomek', 'Nowak', 'teoretical2', 'teoretical2', 1);
...
insert into word.WORD_PRACTIC_EXAM(ID, DATE, EXAM_RESULT, PESEL, EXAMINER_ID, MACHINE_ID) values(4,'2018-02-11 16:00', 1, 38482874823, 7, 3); -- ten egzamin jest do egzaminatora o id=7 jak sie na niego zalogujemy to tylko ten egz sie pokaze

--egzaminy teoretyczne
INSERT INTO word.WORD_TEORETICAL_EXAM(ID, DATE, END_DATE, ROOM, TEORETICAL_EXAM_STATUS, EXAMINER_ID) VALUES (1, '2018-01-01 00:00:00', '2018-01-02 00:00:00', '12', 0, 4);
INSERT INTO word.WORD_TEORETICAL_EXAM(ID, DATE, END_DATE, ROOM, TEORETICAL_EXAM_STATUS, EXAMINER_ID) VALUES (2, '2018-01-01 00:00:00', '2018-01-02 00:00:00', '12', 0, 8);
